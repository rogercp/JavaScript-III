...
*/
function GameObject(atttributes){
  this.createdAt=atttributes.createdAt;
  this.name=atttributes.name;
  this.dimensions=atttributes.dimensions;
}
...
function CharacterStats(atttributes){
  GameObject.call(this,atttributes);
  this.healthPoints=atttributes.healthPoints;
}
...
*/
function Humanoid(atttributes){
  GameObject.call(this,atttributes);
  CharacterStats.call(this,atttributes);
  this.team=atttributes.team;
  this.weapons=atttributes.weapons;
  this.language=atttributes.language;
  
}
Humanoid.prototype=Object.create(GameObject.prototype);
Humanoid.prototype=Object.create(CharacterStats.prototype);
Humanoid.prototype.greet=function(){
  return `${this.name} offers a greting in ${this.language}.`;
}
